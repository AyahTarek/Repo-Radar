 ...
 * between renders.
 */
export const SearchResultCard = memo(function SearchResultCard({ repo }: { repo: RepoSummary }) {
  return (
    <AppCard component="li">
      ...
      >
        ...
        />
        {repo.language !== null && <Chip label={repo.language} size="small" variant="outlined" />}
      </Stack>
    </AppCard>
  );
});
